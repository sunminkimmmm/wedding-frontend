...
class RenunciationCustomers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  render() {
    let newData = this.state.data.filter(function (element) {
      ...
      return element.state === "포기고객";
    });


    return (
      <div>
        <Renunciation {...this.state} onChange={this.onChange} newData={newData}
...
export default RenunciationCustomers;
