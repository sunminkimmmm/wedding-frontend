...
class DeleteCustomers extends Component {
  ...
  render() {
    ...
    let newData = this.state.data.filter(function (element) {
      ...
      return element.contractClassification === "삭제";
    });
    ...
    return (
      <div>
        <Delete {...this.state} newData={newData} details={this.state.details} setDetails={this.setDetails} />
