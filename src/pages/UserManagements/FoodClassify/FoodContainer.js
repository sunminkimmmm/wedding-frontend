...
import { FoodClassifyAPI } from '../../../api';
class FoodContainer extends Component {
    ...
    /**
       ...
       */
    onGetItemList = async () => {
        let result = await FoodClassifyAPI.findAll();
        let itemInfo;
        if (result.code === 200) {
    ...
    onPostItemList = async () => {
        ...
        let result = await FoodClassifyAPI.create(
    ...
    onUpdateItemList = async () => {
        ...
        let result = await FoodClassifyAPI.update(a.id,
            [a.eventClassification, a.itemClassificationName, a.order, a.useStatus]
        )
        return result;
    }
    ...
    onDeleteItemList = async () => {
        ...
        let result = await FoodClassifyAPI.remove(a.id)
        this.props.onGetItemClassifications(a.id);
        return result;
    }
