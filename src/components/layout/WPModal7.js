  ...
  return (
    <div>
      ...
      >
        {(props.toggle === true) ? (
          <div>
            <Descriptions title="부대품목 관리" bordered>
              ...
              <Descriptions.Item label="품목분류" span={3}>
                <Input className="input" name="itemClassifications_ID" onChange={(e) => props.handleChangeState(e)} value={props.data.itemClassifications_ID} />
              </Descriptions.Item>
            ...
            <div>
              <Descriptions title="부대품목관리" bordered>
                <Descriptions.Item label="행사구분" span={3}>
